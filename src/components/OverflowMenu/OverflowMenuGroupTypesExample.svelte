...
{#snippet toggle()}
  <MenuToggle
    aria-label="Group types overflow menu"
    variant="plain"
    isExpanded={isOpen}
    icon={icon}
  />
...
{#snippet dropdownChildren()}
  <DropdownList>
    <OverflowMenuDropdownItem itemId={0} isShared>Item</OverflowMenuDropdownItem>
    <OverflowMenuDropdownItem itemId={1} isShared>Item</OverflowMenuDropdownItem>
    <OverflowMenuDropdownItem itemId={2} isShared>Item</OverflowMenuDropdownItem>
    <OverflowMenuDropdownItem itemId={3} isShared>Primary</OverflowMenuDropdownItem>
    <OverflowMenuDropdownItem itemId={4} isShared>Secondary</OverflowMenuDropdownItem>
    <OverflowMenuDropdownItem itemId={5} isShared>Tertiary</OverflowMenuDropdownItem>
  </DropdownList>
{/snippet}
